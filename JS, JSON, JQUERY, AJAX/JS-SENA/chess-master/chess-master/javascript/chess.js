...
function onClick(event) {
    ...
    let x = Math.floor((event.clientX-chessCanvasX)/TILE_SIZE); //Math.floor. METHOD
    let y = Math.floor((event.clientY-chessCanvasY)/TILE_SIZE); //Rounds number downwards to it's nearest integer
